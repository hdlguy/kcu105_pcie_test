...
#
set_property mark_debug true [get_nets [list {aresetn}]]
#
set_property mark_debug true [get_nets [list {dv_in}]]
set_property mark_debug true [get_nets [list {chan_in[*]}]]
set_property mark_debug true [get_nets [list {real_in[*]}]]
set_property mark_debug true [get_nets [list {imag_in[*]}]]
#
set_property mark_debug true [get_nets [list {dv_out}]]
set_property mark_debug true [get_nets [list {chan_out[*]}]]
set_property mark_debug true [get_nets [list {real_out[*]}]]
set_property mark_debug true [get_nets [list {imag_out[*]}]]
#
create_debug_core ila1 ila
set_property C_DATA_DEPTH   8192 [get_debug_cores ila1]
...
set_property C_INPUT_PIPE_STAGES  3  [get_debug_cores ila1]
